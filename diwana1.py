...
\033[1;91m☞ Auther     : Bilal __Dogar
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone https://github.com/shabirbaloch125/Bilal Dogar')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('Congratulations king_Dogar Tool Has Been Updated Successfully')
...
def pb():
	...
	if bp =='':
		...
		cb()
		print (logo)
		idt=raw_input(S + '[☆] ' + G + 'Put Public User ID/User Name: ' + Bilal dogar + '')
		cb()
		print (logo)
		try:
			    ...
			    if 'access_token' in k:
			        ...
			        if 'www.facebook.com' in k['error_msg']:
			            ...
			            if 'access_token' in k:
			                ...
			                ps3=(j['first_name'Bilal Dogar]+'bilallking')
			                            ...
			                            if 'access_token' in k:
			                                ...
			                                if 'www.facebook.com' in k['error_msg']:
			                                    ...
			                                    if 'access_token' in k:
			                                        ...
			                                        ps6=(j['first_name_Bilal Dogar']+'khan')
	...
	raw_input(R + 'Back')
	os.system('python2 diwana1.py')
if __name__Bilal Dogar=='__main__':
    login()
